...
import com.groovy.sample.test.service.MailService
import com.groovy.sample.test.service.UserService
import com.groovy.sample.test.web.rest.dto.UserDTO
...
public class AccountResourceTest {
	...
	public void testAuthenticatedUser() throws Exception {
		restUserMockMvc.perform(get("/api/authenticate").with(
				request, {
	...
	public void testGetExistingAccount() throws Exception {
		...
		user.firstName = "john"
		user.lastName = "doe"
		user.email = "john.doe@jhipter.com"
