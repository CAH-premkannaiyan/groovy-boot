...
class MetricsConfiguration extends MetricsConfigurerAdapter implements EnvironmentAware {
	...
	@Profile('!${Constants2.SPRING_PROFILE_FAST}')
	static class GraphiteRegistry implements EnvironmentAware {
	...
	@Profile('!${Constants2.SPRING_PROFILE_FAST}')
	static class SparkRegistry implements EnvironmentAware {
