...
@Configuration
@EnableJpaRepositories("com.cardinal.fuse.healthsense.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
class DatabaseConfiguration implements EnvironmentAware {
	...
	@ConditionalOnMissingClass(name = "com.cardinal.fuse.healthsense.config.HerokuDatabaseConfiguration")
