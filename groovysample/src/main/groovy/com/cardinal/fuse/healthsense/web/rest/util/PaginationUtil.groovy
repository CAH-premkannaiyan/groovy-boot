package com.cardinal.fuse.healthsense.web.rest.util
...
class PaginationUtil {
	...
	static final int MIN_OFFSET = 1

	static final int DEFAULT_LIMIT = 20

	static final int MAX_LIMIT = 100

	static Pageable generatePageRequest(Integer offset, Integer limit) {
	...
	static HttpHeaders generatePaginationHttpHeaders(Page page, String baseUrl, Integer offset, Integer limit)
